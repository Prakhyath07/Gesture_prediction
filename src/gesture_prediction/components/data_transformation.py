...
from gesture_prediction.entity.artifact_entity import (
    DataTransformationArtifact,
    DataValidationArtifact,
)
from gesture_prediction.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        try:
            ...
            logging.info("fitting transformer object to train dataset")
            ...
            logging.info("oversampling test data")
            ...
            logging.info("saving transformed test data")
